...
def getAnioInforme():
    while True:
        anioInforme = int(input('Ingrese el año del informe: ')).lower()
    ...
    while True:    
        anioInforme2 = int(input('Vuelva a ingresar el año del informe: ')).lower()
...
def getSemestre():
    while True:
        semestre = int(input('Ingrese el semestre que corresponda: ')).lower()
...
def getClaustroDenunciante():
    while True:
        claustro = str(input('Ingresar el claustro del denunciante: ')).lower()
...
def getClaustroPersonaDenunciada():
    while True:
        claustro = str(input('Ingresar el claustro de la persona denunciada: ')).lower()
