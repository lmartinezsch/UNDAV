...
def main():
    ...
    while True:
        ...
        if voto == "*":
            ...
            print('La lista ingresada no forma parte del escrutinio. Vuelva ingresar su voto.')
            continue
    ...
    avgListaA = round(listaA / cantidadVotantes * 100, 2)
    avgListaB = round(listaB / cantidadVotantes * 100, 2)
    avgListaC = round(listaC / cantidadVotantes * 100, 2)
    avgListaD = round(listaD / cantidadVotantes * 100, 2)
